...
Spanish Paraguay translation and terminology adjustments for iDempiere ERP.

## Purpose

This repository contains translation notes, terminology rules and XML translation resources for adapting iDempiere ERP to Spanish used in Paraguay.

The goal is to improve clarity, consistency and localization of iDempiere terms for local ERP implementations.
